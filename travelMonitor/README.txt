...
3) Όταν πεθαίνει μία διεργασία - παιδί και αναγεννάται, δεν διατηρεί τους τρέχοντες μετρητές
...
4) Οι διεργασίες - παιδιά και η διεργασία - γονέας έχουν τους ίδιους μετρητές αιτημάτων που έγιναν
  accepted/rejected (εκτός από τη περίπτωση 3). Δηλαδή, η διεργασία - γονέας ενημερώνει κάθε φορά 
  το κατάλληλο monitor για τυχόν αιτήματα που δεν χρειάστηκε να γίνει επικοινωνία μέσω named pipe 
  για να απαντηθούν.

5) Υποθέτω ότι όλες οι χώρες ελέγχουν για εμβολιασμό κάθε ιό που εισάγει ο χρήστης. Μάλιστα,
  αν αυτός ο ιός δεν προϋπήρχε στην βάση, τότε θα προστεθεί έτσι όπως τον έδωσε ο χρήστης.

6) Η εφαρμογή είναι έτοιμη να δεχτεί εντολές από τον χρήστη όταν στο terminal εκτυπωθεί με 
  πράσινα γράμματα "Enter command: ". Μπορεί να πάρει το πολύ 5 δευτερόλεπτα να εμφανιστεί 
  τη πρώτη φορά αυτό κατά την εκτέλεση της εφαρμογής.